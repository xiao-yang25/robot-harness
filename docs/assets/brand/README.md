# Kingfisher preview identity

The kingfisher is the current public preview mark for Robot Harness. It is in
trial use and may change as the project develops. The original silhouette is
retained; the two SVGs differ only in foreground color.

- [Light-background mark](kingfisher-light.svg): dark ink on transparency.
- [Dark-background mark](kingfisher-dark.svg): warm white on transparency.

The long beak and swept wing and tail suggest **observe, act, return**: carry an
